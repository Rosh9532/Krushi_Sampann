...
// Microsoft forgot to hump their style prefix (#9572)
...
// Return a style-prefixed property or undefined
function stylePropName( name ) {

	// Check for style prefixed names
...
// Return a potentially-mapped jQuery.cssProps or style prefixed property
function finalPropName( name ) {
	var final = jQuery.cssProps[ name ] || styleProps[ name ];
	...
	return styleProps[ name ] = stylePropName( name ) || name;
}
