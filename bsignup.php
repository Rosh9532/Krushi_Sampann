...
<div> <header style="background-color: #242424; ">
    ...
    <div class="row">
       ...
       <div class="card-body">
       <form method="POST" action="bsignup_backend.php">
       ...
       <input type="text" class="form-control"placeholder="Enter Address" name="adr">
        <br>
        <p><b>Please select your Category:</b></p>
      ...
      <label for="Farmer">Farmer</label><br>
       ...
       <div class="card-footer text-muted">
         <a href="blogin.php"style="text decoration:none">Already have an account?Log in</a>
