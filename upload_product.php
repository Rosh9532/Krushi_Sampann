  ...
  <div class="cont">
    ...
    <div class="row">
      ...
      <div class="col-lg-3" style="padding-top:20px;">
        ...
        <div class="list-group">
          <a href="home.php" class="list-group-item" style= "color:green; font-weight:bold;">HOME</a>
		   <a href="fprofile.php" class="list-group-item" style= "color:green; font-weight:bold;">PROILE</a>
      ...
      <div class="col-lg-8" style="padding-left:0px; margin-left:-50px;padding-top:30px;">
        ...
        <form method="POST" action="upload_productback.php" enctype="multipart/form-data">
          <h2 style="background-color:#74cc5c; padding:20px;color:white;"><b>Upload the Product Information here..!!</b></h2>
		  <br>
          ...
          <br>
      <div  style="margin-left:15px;" ><b>Image of Product :</b>
        <input type="file" name="productPic" style="margin-left:20px;"></input>
        <br />
      </div>
     <br>
          <div class="col-sm-6" style="">
            <div class="select-wrapper" style="width:100px;" >
              <select name="type" id="type" required style="background-color:white; color: black; width:150px;  align:center;">
      ...
      <br>
      <div>
        <textarea  name="pinfo" id="pinfo" rows="12" style="padding=10px;"></textarea>
      </div>
    <br>
    <div class="row">
      ...
      <button type="submit" name="submit"class="btn btn-success btn-lg btn-block" style="align:center;">SUBMIT</button>
      </div>
    </div>
    </form>
